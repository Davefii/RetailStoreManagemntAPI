...
namespace RetailStoreManagment.Controllers
{
    ...
    public class AuthunticationController : Controller
    {
        ...
        public AuthunticationController(ILogger<LoginRequest> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        public ActionResult<UserDTO> LoginUser(LoginRequest loginUserRequest)
        {
